				...
				<div className="drawer drawer-mobile ">
					...
					<div className="drawer-side ">
						...
						<ul className="menu p-4 overflow-y-auto w-80 bg-white border-r-1 shadow-2xl  text-slate-600 font-semibold" id='slideBar'>
							...
							<li className='py-1 text-lg hover:text-black rounded'><CustomLink className='flex gap-4 capitalize' to={'/ticket'}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-slate-600 w-6">
